<template>
  <div class="container-fluid text-center mt-3">
    ...
    <a target="_blank" href="https://blastchat.xyz">Built for Blast Chat</a>
  </div>
  ...
  <div class="container-fluid text-center">
    ...
    <a class="icons" target="_blank" href="https://github.com/blastchatxyz"><i class="bi bi-github"></i></a>
