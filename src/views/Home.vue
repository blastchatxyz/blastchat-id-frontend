<template>
  <div class="container text-center">
    <img class="img-fluid main-img rounded" src="../assets/logo-wide.svg" />

    <div class="text-align-header mt-5 mb-2">
      <h1>Mint your {{getTldName}} web3 username!</h1>
      <p>
        And use it as username on  
        <a href="https://blastchat.xyz" target="_blank">
          BlastChat, a decentralized social network on Blast
        </a>.
      </p>
    </div>
